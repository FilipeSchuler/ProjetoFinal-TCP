...
public class Interface {
    ...
    private static final int TEXT_MUSIC_SPACE_WIDTH = 600, TEXT_MUSIC_SPACE_HEIGHT = 400;
    private static final int POSITION_X_HEADTEXT = 5, POSITION_Y_HEADTEXT = 0;
    private static final int HEIGHT_HEADTEXT = 20, WIDTH_HEADTEXT = 160;
    private static final int FONT_SIZE = 20;
    private static final int POSITION_X_TEXTAREA = 5, POSITION_Y_TEXTAREA = 20;
    private static final int POSITION_X_BPM_LABEL = 650, POSITION_Y_BPM_LABEL = 350;
    private static final int HEIGHT_BPM_LABEL = 20, WIDTH_BPM_LABEL = 30;
    private static final int POSITION_X_BPM_TEXT = 690, POSITION_Y_BPM_TEXT = 350;
    private static final int HEIGHT_BPM_TEXT = 20, WIDTH_BPM_TEXT = 50;
    private static final int POSITION_X_SCROLLPANE = 5, POSITION_Y_SCROLLPANE = 20;
    private static final int HEIGHT_SCROLLPANE = 400, WIDTH_SCROLLPANE = 600;
